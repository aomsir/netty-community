...
public class NettyHttpServer {
    ...
    private static final Logger log2 = LoggerFactory.getLogger(NettyHttpServer.class);
    private static final Logger log1 = LoggerFactory.getLogger(NettyHttpServer.class);
